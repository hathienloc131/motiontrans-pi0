...
exp_name="pp_rel_robot"                           # the description of the experiment target
repo_id="pp_rel_robot"          # identifier only, used for norm-stats/assets dir naming
dataset_root="/mnt/data/sftp/data/locht1/vr_data/robot_stack_three_cup"   # local directory containing the LeRobot dataset (meta/, data/, videos/)
